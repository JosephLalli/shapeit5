...
scaffold_bcf="$tmp_dir/target.scaffold.oneallele.micro_donor.wgs.family.bcf"
scaffold_stats="$tmp_dir/target.scaffold.oneallele.micro_donor.wgs.family.stats"
scaffold_debug="$tmp_dir/target.scaffold.oneallele.micro_donor.wgs.family.debug"
output_bcf="$tmp_dir/target.phased.oneallele.micro_donor.wgs.family.bcf"
...
log_file="$tmp_dir/phase_rare.family.micro_donor.log"
if ../phase_rare/bin/phase_rare \
  ...
  echo "Rare variant phasing (MICRO_DONOR, family) completed successfully"
else
...
filtered_bcf="$tmp_dir/target.phased.oneallele.micro_donor.wgs.family.filtered.bcf"
...
assert_same_md5 "$scaffold_bcf" "phase.wgs.family.micro_donor.common"
assert_same_md5 "$filtered_bcf" "phase.wgs.family.micro_donor"
