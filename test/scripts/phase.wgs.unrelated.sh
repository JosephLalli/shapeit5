...
scaffold_bcf="$tmp_dir/target.scaffold.wgs.unrelated.bcf"
output_bcf="$tmp_dir/target.phased.wgs.unrelated.bcf"
...
filtered_bcf="$tmp_dir/target.phased.wgs.unrelated.filtered.bcf"
