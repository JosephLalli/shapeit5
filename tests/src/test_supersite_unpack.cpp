...
int main() {
    TEST_INIT("test_supersite_unpack");
    ...
    TEST_PASS("  Single code unpacking");  // was: OK
    ...
    TEST_PASS("  Batch code unpacking");  // was: OK
    ...
    TEST_PASS("  Vectorized code unpacking");  // was: OK
    ...
    TEST_PASS("  Offset unpacking");  // was: OK
    ...
    TEST_PASS("  REF vs ALT code unpacking");  // was: OK
