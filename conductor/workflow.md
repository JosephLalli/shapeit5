...
4. **High Code Coverage:** Aim for >80% code coverage for all new features (legacy code may have lower coverage)
...
6. **Verify Coverage:** Run coverage reports using the project's chosen tools. For example, in a Python project, this might look like:
   ...
   ```
   Target: >80% coverage for new features. The specific tools and commands will vary by language and framework.
...
8. **Commit Code Changes:**
   ...
   - Propose a **detailed and descriptive** commit message e.g, `feat(ui): Create basic HTML structure for calculator`.
   - Perform the commit.
...
- [ ] All tests pass
- [ ] Code coverage meets requirements (>80% for new features)
...
3. **Testing**
   ...
   - Coverage adequate (>80% for new features)
...
3. Code coverage meets project requirements (>80% for new features)
